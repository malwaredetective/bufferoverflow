...
def main():
	...
	exploit = subparser.add_parser('exploit', description="A Python script used exploit stack-based Buffer Overflow vulnerabilities. This module can be used to launch your Buffer Overflow attack and execute shellcode against a vulnerable application. Warning: Rememeber to manually update the script to modify the EIP and upload your custom shellcode.", help='Exploit a vulnerable application with a stack-based Buffer Overflow attack to execute shellcode.')
